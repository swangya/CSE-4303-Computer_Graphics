...
class cl_widgets:
    def __init__(self, ob_root_window, ob_world=[]):
        ...
        self.rotate_bar = c1_rotate_bar(self)
...
class c1_rotate_bar:
    def __init__(self, master):
        ...
        self.point1.set('0 0 0')
        self.point2 = tk.StringVar()
        self.point2.set('0 1 0')
        ...
        self.heading = tk.Label(self.rotate, text="Rotation ---> Enter Point space separated A:").pack(side=tk.LEFT)
        self.entry = tk.Entry(self.rotate, textvariable=self.point1, width=10).pack(side=tk.LEFT)

        self.heading = tk.Label(self.rotate, text="B:").pack(side=tk.LEFT)
        self.entry = tk.Entry(self.rotate, textvariable=self.point2, width=10).pack(side=tk.LEFT)

        self.heading = tk.Label(self.rotate, text="Degrees:").pack(side=tk.LEFT)
        self.entry = tk.Entry(self.rotate, textvariable=self.degree, width=10).pack(side=tk.LEFT)

        self.button = tk.Button(self.rotate, text="Rotate", width=16, command=self.activate)
    ...
    def activate(self):
        ...
        line = [0.0, 0.0, 0.0]
        for i in range(0, 3):
            line[i] = float(self.pointB[i]) - float(self.pointA[i])
